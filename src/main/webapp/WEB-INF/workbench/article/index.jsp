...
<%--导入分页插件--%>
<link href="/js/jquery/bs_pagination/jquery.bs_pagination.min.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="/js/jquery/bs_pagination/en.js"></script>
<script type="text/javascript" src="/js/jquery/bs_pagination/jquery.bs_pagination.min.js"></script>
</head>
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="/toView/workbench/article/addArticle">增加文章</a></li>
        </ol>
...
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <%--<div class="modal-body"> <img src="images/baoman_01.gif" alt="深思熟虑" />--%>
...
<%--导入分页插件--%>
<link type="text/css" href="/js/bs_pagination/jquery.bs_pagination.min.css" />
<script src="/js/bs_pagination/en.js"></script>
<script src="/js/bs_pagination/jquery.bs_pagination.min.js"></script>
<script>
    ...
    for (var i = 0; i < articles.length; i++) {
      ...
      if (article.isOpen == "0") {
        ...
        $('#articleBody').append("<tr>\n" +
                ...
                "                <td>\n" +
                "                    <a href=\"/toView/workbench/article/updateArticle?id="+article.aid+"\">修改</a> <a onclick=\"deleteById('"+article.aid+"')\" href='javascript:void(0)'>删除</a>&nbsp;\n" +
...
function deleteById(aid) {
  $.get("/article/deleteById",{'id':aid},function (data) {
    if(data.ok){
      //删除成功
      layer.alert(data.mess, {icon:6});
      //刷新页面
